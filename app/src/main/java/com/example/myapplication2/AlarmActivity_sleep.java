...
public class AlarmActivity_sleep extends AppCompatActivity {
    Calendar calendar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        {
            ...
            alarm_btn_pills = (Button) findViewById(R.id.alarm_sleep_btn);
            timeText = (TextView) findViewById(R.id.sleep_alarm_time);
