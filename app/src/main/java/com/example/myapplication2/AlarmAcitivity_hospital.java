...
public class AlarmAcitivity_hospital extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        {
            ...
            setContentView(R.layout.activity_alarm_hospital);
            // Log.d("알람 페이지", "실행");
            calendar = Calendar.getInstance();
            alarm_btn_pills = (Button) findViewById(R.id.alarm_hospital_btn);
            timeText = (TextView) findViewById(R.id.hospital_alarm_time);
